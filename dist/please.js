...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(3);var Util=function Util(){/**
		 ...
		 * @param  {Any} color
		 * @return {Boolean}
		 */this._isHsv=function(color){if((0,_lodash.isObject)(color)&&color.h!=null&&color.s!=null&&color.v!=null){return true;}return false;};/**
		 * Returns true if color is HSL and false otherwise.
		 * @param  {Any} color
		 * @return {Boolean}
		 */this._isHsl=function(color){if((0,_lodash.isObject)(color)&&color.h!=null&&color.s!=null&&color.l!=null){return true;}return false;};/**
		 * Returns true if color is an HSL string and false otherwise.
		 * @param  {Any} color
		 * @return {Boolean}
		 */this._isHslString=function(color){var hslTest=/hsl\(s?d{1,3},s?d{1,3}%,s?d{1,3}%s?\)/i;if((0,_lodash.isString)(color)&&hslTest.test(color)){return true;}return false;};/**
		 * Returns true if color is RGB and false otherwise.
		 * @param  {Any} color
		 * @return {Boolean}
		 */this._isRgb=function(color){if((0,_lodash.isObject)(color)&&color.r!=null&&color.g!=null&&color.b!=null){return true;}return false;};/**
		 * Returns true if color is an RGB string and false otherwise.
		 * @param  {Any} color
		 * @return {Boolean}
		 */this._isRgbString=function(color){var rgbTest=/rgb\(\s?(\d{1,3},\s?){2}\d{1,3}\s?\)/i;if((0,_lodash.isString)(color)&&rgbTest.test(color)){return true;}return false;};/**
		 * Returns true if color is an HTML color and false otherwise.
		 * @param  {Any} color
		 * @return {Boolean}
		 */this._isHtml=function(color){var normalizedColor=color.toLowerCase();if((0,_lodash.isString)(normalizedColor)&&normalizedColor in htmlColors){return true;}return false;};/**
		 * Returns true if color is a Hex string and false otherwise.
		 * @param  {Any} color
		 * @return {Boolean}
		 */this._isHex=function(color){var hexTest=/^#?(?:[0-9a-f]{3}){1,2}$/i;if((0,_lodash.isString)(color)&&hexTest.test(color)){return true;}return false;};/**
		 * Returns true if color is XYZ and false otherwise.
		 * @param  {Any} color
		 * @return {Boolean}
		 */this._isXyz=function(color){if((0,_lodash.isObject)(color)&&color.x!=null&&color.y!=null&&color.z!=null){return true;}return false;};/**
		 * Returns true if color is LAB and false otherwise.
		 * @param  {Any} color
		 * @return {Boolean}
		 */this._isLab=function(color){if((0,_lodash.isObject)(color)&&color.l!=null&&color.a!=null&&color.b!=null){return true;}return false;};/**
		 * Returns true is color is CMY and false otherwise.
		 * @param  {Any} color
		 * @return {Boolean}
		 */this._isCmy=function(color){if((0,_lodash.isObject)(color)&&color.c!=null&&color.m!=null&&color.y!=null){return true;}return false;};/**
		 * Returns true if color is CMYK and false otherwise.
		 * @param  {Any} color
		 * @return {Boolean}
		 */this._isCmyk=function(color){if(this._isCmy(color)&&color.k!=null){return true;}return false;};};exports.default=Util;
