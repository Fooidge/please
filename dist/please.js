...
/***/ function(module, exports, __webpack_require__) {
	...
	var opts=deprecationLayer((0,_lodash.defaults)(makeColorDefaults,options));var colors=[];for(var i=0;i<opts.colorsReturned;i++){colors[i]=please.generate();//remove overwrites after 3 months in the wild
