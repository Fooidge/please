...
/***/ function(module, exports) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};var isArray=Array.isArray;var objectProto=Object.prototype;var objectToString=objectProto.toString;var hasOwnProperty=objectProto.hasOwnProperty;var stringTag='[object String]';var clamp=function clamp(value,min,max){return Math.max(min,Math.min(max,value));};//Adapted from _.isNumber
...
/***/ function(module, exports, __webpack_require__) {
	...
	},{key:'mix',value:function mix(color){var amount=arguments.length>1&&arguments[1]!==undefined?arguments[1]:0.5;var cmyk=this._hsvToCmyk(this.__model);var mixer=this._hsvToCmyk(color);amount=(0,_util.clamp)(amount,0,1);var remainder=1-amount;var result={c:(0,_util.clamp)(cmyk.c*remainder+mixer.c*amount,0,1),m:(0,_util.clamp)(cmyk.m*remainder+mixer.m*amount,0,1),y:(0,_util.clamp)(cmyk.y*remainder+mixer.y*amount,0,1),k:(0,_util.clamp)(cmyk.k*remainder+mixer.k*amount,0,1)};console.log(result);this.__model=this._cmykToHsv(result);return this;}},{key:'lighten',value:function lighten(){var amount=arguments.length>0&&arguments[0]!==undefined?arguments[0]:0.25;var white=new Color(this._htmlColors.white);this.mix(white.hsv(),amount);return this;}},{key:'darken',value:function darken(){var amount=arguments.length>0&&arguments[0]!==undefined?arguments[0]:0.25;var black=new Color(this._htmlColors.black);this.mix(black.hsv(),amount);return this;}}]);return Color;}();exports.default=Color;;
