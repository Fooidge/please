...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(3);var _Color=__webpack_require__(6);var _Color2=_interopRequireDefault(_Color);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var please={};exports.default=please;please.Color=function(color){return new _Color2.default(color);};var PHI=0.618033988749895;var makeColorDefaults={hue:null,saturation:null,value:null,base_color:'',baseColor:'',greyscale:false,grayscale:false,//whatever I support them both, murrica
	golden:true,full_random:false,fullRandom:false,colors_returned:1,colorsReturned:1,format:null};please.generateFromBaseColor=function(baseColor){var color=new _Color2.default();var base=new _Color2.default(baseColor);color.hue(clamp((0,_lodash.random)(base.hue()-5,base.hue()+5),0,360));if(base.saturation()===0){color.saturation(0);}else{color.saturation((0,_lodash.random)(0.4,0.85,true));}color.value((0,_lodash.random)(0.4,0.85,true));return color;};please.generate=please.generateGolden=function(){var color=new _Color2.default();var hue=(0,_lodash.random)(0,359);color.hue((hue+hue/PHI)%360);color.saturation((0,_lodash.random)(0.4,0.85,true));color.value((0,_lodash.random)(0.4,0.85,true));return color;};please.generateRandom=function(){var color=new _Color2.default();color.hue((0,_lodash.random)(0,359));color.saturation((0,_lodash.random)(0,1.0,true));color.value((0,_lodash.random)(0,1.0,true));return color;};var deprecationLayer=function deprecationLayer(options){if(options.base_color!==makeColorDefaults.baseColor){console.warn('The option base_color is deprecated and will be removed soon. Use baseColor instead.');options.baseColor=options.base_color;}if(options.full_random!==makeColorDefaults.fullRandom){console.warn('The option full_random is deprecated and will be removed soon. Use fullRandom instead.');options.fullRandom=options.full_random;}if(options.colors_returned!==makeColorDefaults.colorsReturned){console.warn('The option colors_returned is deprecated and will be removed soon. Use colorsReturned instead.');options.colorsReturned=options.colors_returned;}return options;};//remove make_color after 3 months in the wild
	...
	var opts=deprecationLayer((0,_lodash.defaults)(makeColorDefaults,options));var colors=[];var iterable=__range__(0,opts.colorsReturned,true);for(var j=0;j<iterable.length;j++){var i=iterable[j];colors[i]=please.generate();//remove overwrites after 3 months in the wild
	//overwrite values if option exists to
	if(opts.hue!=null&&(0,_lodash.isNumber)(opts.hue)){colors[i].hue(opts.hue);}if(opts.saturation!=null&&(0,_lodash.isNumber)(opts.saturation)){colors[i].saturation(opts.saturation);}if(opts.value!=null&&(0,_lodash.isNumber)(opts.value)){colors[i].value(opts.value);}switch(opts.format.toLowerCase()){case'hex':colors[i]=colors[i].hex();break;case'rgb':colors[i]=colors[i].rgbString();break;case'hsl':colors[i]=colors[i].hslString();break;default:console.warn('Unknown format. Defaulting to hex.');colors[i]=colors[i].hex();}}return colors;};//remove make_scheme after 3 months in the wild
	please.make_scheme=function(){var options=arguments.length<=0||arguments[0]===undefined?{}:arguments[0];console.warn('The function make_scheme() is deprecated and will be removed soon. use makeScheme() instead.');please.makeScheme(options);};please.makeScheme=function(){var options=arguments.length<=0||arguments[0]===undefined?{}:arguments[0];var scheme=[];return scheme;};function __range__(left,right,inclusive){var range=[];var ascending=left<right;var end=!inclusive?right:ascending?right+1:right-1;for(var i=left;ascending?i<end:i>end;ascending?i++:i--){range.push(i);}return range;}
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _lodash=__webpack_require__(3);var _htmlColors=__webpack_require__(7);var _htmlColors2=_interopRequireDefault(_htmlColors);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var Color=function(){function Color(color){_classCallCheck(this,Color);if(color!=null){switch(this._detectType(color)){case'HSV':this.__model={h:color.h,s:color.s,v:color.v};break;case'HSL':this.__model=this._hslToHsv(color);break;case'RGB':this.__model=this._rgbToHsv(color);break;case'HEX':this.__model=this._hexToHsv(color);break;case'XYZ':this.__model=this._xyzToHsv(color);break;case'LAB':this.__model=this._labToHsv(color);break;case'CMYK':this.__model=this._cmykToHsv(color);break;}}else{this.__model={h:0,s:0,v:0};}}_createClass(Color,[{key:'_detectType',value:function _detectType(color){if(this._isHsv(color)){return'HSV';}if(this._isHsl(color)){return'HSL';}if(this._isRgb(color)){return'RGB';}if(this._isRgbString(color)){return'RGB_STRING';}if(this._isHex(color)){return'HEX';}if(this._isXyz(color)){return'XYZ';}if(this._isLab(color)){return'LAB';}if(this._isCmyk(color)){return'CMYK';}throw new Error('Not a valid color type.');}},{key:'_isHsv',value:function _isHsv(color){if((0,_lodash.isObject)(color)&&color.h!=null&&color.s!=null&&color.v!=null){return true;}return false;}},{key:'_isHsl',value:function _isHsl(color){if((0,_lodash.isObject)(color)&&color.h!=null&&color.s!=null&&color.l!=null){return true;}return false;}},{key:'_isHslString',value:function _isHslString(color){var hslTest=/hsl\(s?d{1,3},s?d{1,3}%,s?d{1,3}%s?\)/i;if((0,_lodash.isString)(color)&&hslTest.test(color)){return true;}return false;}},{key:'_isRgb',value:function _isRgb(color){if((0,_lodash.isObject)(color)&&color.r!=null&&color.g!=null&&color.b!=null){return true;}return false;}},{key:'_isRgbString',value:function _isRgbString(color){var rgbTest=/rgb\(\s?(\d{1,3},\s?){2}\d{1,3}\s?\)/i;if((0,_lodash.isString)(color)&&rgbTest.test(color)){return true;}return false;}},{key:'_isHex',value:function _isHex(color){var hexTest=/^#?(?:[0-9a-f]{3}){1,2}$/i;if((0,_lodash.isString)(color)&&hexTest.test(color)){return true;}return false;}},{key:'_isXyz',value:function _isXyz(color){if((0,_lodash.isObject)(color)&&color.x!=null&&color.y!=null&&color.z!=null){return true;}return false;}},{key:'_isLab',value:function _isLab(color){if((0,_lodash.isObject)(color)&&color.l!=null&&color.a!=null&&color.b!=null){return true;}return false;}},{key:'_isCmy',value:function _isCmy(color){if((0,_lodash.isObject)(color)&&color.c!=null&&color.m!=null&&color.y!=null){return true;}return false;}},{key:'_isCmyk',value:function _isCmyk(color){if(this._isCmy(color)&&color.k!=null){return true;}return false;}},{key:'hue',value:function hue(value){if(value!=null&&(0,_lodash.isNumber)(value)){this.__model.h=Math.abs(value%360);return this;}return this.__model.h;}},{key:'saturation',value:function saturation(value){if(value!=null&&(0,_lodash.isNumber)(value)){this.__model.s=(0,_lodash.clamp)(value,0,1);return this;}return this.__model.s;}},{key:'sat',value:function sat(value){return this.saturation(value);}},{key:'value',value:function value(_value){if(_value!=null&&(0,_lodash.isNumber)(_value)){this.__model.v=(0,_lodash.clamp)(_value,0,1);return this;}return this.__model.v;}},{key:'val',value:function val(value){return this.value(value);}},{key:'brightness',value:function brightness(value){return this.value(value);}},{key:'alpha',value:function alpha(value){if(value!=null&&(0,_lodash.isNumber)(value)){this.__model.a=(0,_lodash.clamp)(value,0,1);return this;}return this.__model.a;}},{key:'opacity',value:function opacity(value){return this.alpha(value);}},{key:'red',value:function red(value){if(value!=null&&(0,_lodash.isNumber)(value)){var rgb=this._hsvToRgb(this.__model);rgb.r=(0,_lodash.clamp)(value,0,255);this.__model=this._rgbToHsv(rgb);return this;}return this._hsvToRgb(this.__model).r;}},{key:'green',value:function green(value){if(value!=null&&(0,_lodash.isNumber)(value)){var rgb=this._hsvToRgb(this.__model);rgb.g=(0,_lodash.clamp)(value,0,255);this.__model=this._rgbToHsv(rgb);return this;}return this._hsvToRgb(this.__model).g;}},{key:'blue',value:function blue(value){if(value!=null&&(0,_lodash.isNumber)(value)){var rgb=this._hsvToRgb(this.__model);rgb.b=(0,_lodash.clamp)(value,0,255);this.__model=this._rgbToHsv(rgb);return this;}return this._hsvToRgb(this.__model).b;}},{key:'rgb',value:function rgb(value){if(value!=null){this.__model=this._rgbToHsv(value);return this;}return this._hsvToRgb(this.__model);}},{key:'rgbString',value:function rgbString(){var rgb=this.rgb();var r=Math.round(rgb.r);var g=Math.round(rgb.g);var b=Math.round(rgb.b);if(this.__model.a==null){return'rgb('+r+','+g+','+b+')';}return'rgba('+r+','+g+','+b+','+this.__model.a+')';}},{key:'hsl',value:function hsl(value){if(value!=null){this.__model=this._hslToHsv(value);return this;}return this._hsvToHsl(this.__model);}},{key:'hslString',value:function hslString(){var hsl=this._hsvToHsl(this.__model);var h=hsl.h;var s=hsl.s*100;var l=hsl.l*100;if(this.__model.a==null){return'hsl('+h+','+s+'%,'+l+'%)';}return'hsla('+h+','+s+'%,'+l+'%,'+this.__model.a+')';}},{key:'hsv',value:function hsv(value){if(value!=null&&this._isHsv(value)){this.__model=value;return this;}return this.__model;}},{key:'xyz',value:function xyz(value){if(value!=null&&this._isXyz(value)){this.__model=this._xyzToHsv(value);return this;}return this._hsvToXyz(this.__model);}},{key:'hex',value:function hex(value){if(value!=null&&this._isHex(value)){this.__model=this._hexToHsv(value);return this;}return this._hsvToHex(this.__model);}},{key:'html',value:function html(value){this.__model=this._hexToHsv(this.getHtmlColor(value));return this;}},{key:'getHtmlColor',value:function getHtmlColor(value){if(value!=null){var colorName=value.toString().toLowerCase();if(_htmlColors2.default[colorName]!=null){return _htmlColors2.default[colorName];}}throw new Error('Not a valid HTML color.');}},{key:'getHtmlColors',value:function getHtmlColors(){return _htmlColors2.default;}//true for white false for black
	...
	},{key:'mix',value:function mix(color){var amount=arguments.length<=1||arguments[1]===undefined?0.5:arguments[1];var cmyk=this._hsvToCmyk(this.__model);var mixer=this._hsvToCmyk(color);amount=(0,_lodash.clamp)(amount,0,1);var remainder=1-amount;var result={c:cmyk.c*remainder+mixer.c*amount,m:cmyk.m*remainder+mixer.m*amount,y:cmyk.y*remainder+mixer.y*amount,k:cmyk.k*remainder+mixer.k*amount};this.__model=this._cmykToHsv(result);return this;}},{key:'lighten',value:function lighten(){var amount=arguments.length<=0||arguments[0]===undefined?0.25:arguments[0];var white=new Color(_htmlColors2.default.white);this.mix(white.hsv(),amount);return this;}},{key:'darken',value:function darken(){var amount=arguments.length<=0||arguments[0]===undefined?0.25:arguments[0];var black=new Color(_htmlColors2.default.black);this.mix(black.hsv(),amount);return this;}},{key:'_rgbToHsv',value:function _rgbToHsv(rgb){if(!this._isRgb(rgb)){throw new Error('Not a valid RGB object.');}var r=rgb.r/255;var g=rgb.g/255;var b=rgb.b/255;var minRgb=Math.min(r,Math.min(g,b));var maxRgb=Math.max(r,Math.max(g,b));//Black-gray-white
	if(minRgb===maxRgb){var hsvObj={h:0,s:0,v:minRgb};return hsvObj;}//Colors other than black-gray-white:
	var d=r===minRgb?g-b:b===minRgb?r-g:b-r;var h=r===minRgb?3:b===minRgb?1:5;var hsvObj={h:60*(h-d/(maxRgb-minRgb)),s:(maxRgb-minRgb)/maxRgb,v:maxRgb};return hsvObj;}},{key:'_hsvToRgb',value:function _hsvToRgb(hsv){if(!this._isHsv(hsv)){throw new Error('Not a valid HSV object.');}var h=hsv.h%360;var s=hsv.s;var v=hsv.v;//no saturation case
	if(s===0){var computedV=v*255;var rgbObj={r:computedV,g:computedV,b:computedV};return rgbObj;}h/=60;var i=Math.floor(h);var f=h-i;var p=v*(1-s);var q=v*(1-s*f);var t=v*(1-s*(1-f));switch(i){case 0:var r=v;var g=t;var b=p;break;case 1:r=q;g=v;b=p;break;case 2:r=p;g=v;b=t;break;case 3:r=p;g=q;b=v;break;case 4:r=t;g=p;b=v;break;case 5:r=v;g=p;b=q;break;}var rgbObj={r:Math.floor(r*255),g:Math.floor(g*255),b:Math.floor(b*255)};return rgbObj;}},{key:'_hexToRgb',value:function _hexToRgb(hex){if(!this._isHex(hex)){throw new Error('Not a valid hex string.');}//expand to long version
	hex=hex.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(m,r,g,b){return r+r+g+g+b+b;});//remove everything expect valid numbers
	hex=hex.replace(/[^0-9a-f]/gi,'');var parsedHex=parseInt(hex,16);var rgbObj={r:parsedHex>>16&255,g:parsedHex>>8&255,b:parsedHex&255};return rgbObj;}},{key:'_hexToHsv',value:function _hexToHsv(hex){return this._rgbToHsv(this._hexToRgb(hex));}},{key:'_rgbToHex',value:function _rgbToHex(rgb){if(!this._isRgb(rgb)){throw new Error('Not a valid RGB object.');}var base=rgb.b|rgb.g<<8|rgb.r<<16;return'#'+(0x1000000+base).toString(16).slice(1);}},{key:'_hsvToHex',value:function _hsvToHex(hsv){return this._rgbToHex(this._hsvToRgb(hsv));}},{key:'_hsvToHsl',value:function _hsvToHsl(hsv){if(!this._isHsv(hsv)){throw new Error('Not a valid HSV object.');}var computedL=(2-hsv.s)*hsv.v;var computedS=hsv.s*hsv.v;if(computedL<=1){computedS=computedS/computedL;}else{computedS=computedS/(2-computedL);}computedL=computedL/2;var hslObj={h:hsv.h,s:computedS,l:computedL};return hslObj;}},{key:'_hslToHsv',value:function _hslToHsv(hsl){if(!this._isHsl(hsl)){throw new Error('Not a valid HSL object.');}hsl.l*=2;if(hsl.l<=1){hsl.s*=hsl.l;}else{hsl.s*=2-hsl.l;}var computedV=(hsl.l+hsl.s)/2;var computedS=2*hsl.s/(hsl.l+hsl.s);var hsvObj={h:hsl.h,s:computedS,v:computedV};return hsvObj;}},{key:'_hsvToXyz',value:function _hsvToXyz(hsv){return this._rgbToXyz(this._hsvToRgb(hsv));}},{key:'_xyzToHsv',value:function _xyzToHsv(xyz){return this._rgbToHsv(this._xyzToRgb(xyz));}},{key:'__xyzForward',value:function __xyzForward(value){if(value>0.04045){return Math.pow((value+0.055)/1.055,2.4);}return value/12.92;}},{key:'_rgbToXyz',value:function _rgbToXyz(rgb){if(!this._isRgb(rgb)){throw new Error('Not a valid RGB object.');}var r=this.__xyzForward(rgb.r);var g=this.__xyzForward(rgb.g);var b=this.__xyzForward(rgb.b);var xyzObj={x:r*0.4124+g*0.3576+b*0.1805,y:r*0.2126+g*0.7152+b*0.0722,z:r*0.0193+g*0.1192+b*0.9505};return xyzObj;}},{key:'__xyzBackward',value:function __xyzBackward(value){if(value>0.0031308){return Math.pow(value,1/2.4)-0.055;}return value*12.92;}},{key:'_xyzToRgb',value:function _xyzToRgb(xyz){if(!this._isXyz(xyz)){throw new Error('Not a valid XYZ object.');}var r=xyz.x*3.2406+xyz.y*-1.5372+xyz.z*-0.4986;var g=xyz.x*-0.9689+xyz.y*1.8758+xyz.z*0.0415;var b=xyz.x*0.0557+xyz.y*-0.2040+xyz.z*1.057;var rgbObj={r:this.__xyzBackward(r),g:this.__xyzBackward(g),b:this.__xyzBackward(b)};return rgbObj;}},{key:'__labForward',value:function __labForward(value){if(value>0.008856){return Math.pow(x,1/3);}return 7.787*x+16/116;}},{key:'_xyzToLab',value:function _xyzToLab(xyz){if(!this._isXyz(xyz)){throw new Error('Not a valid XYZ object.');}// CIE-L*ab D65/2' 1931
	...
	};return labObj;}},{key:'__labBackward',value:function __labBackward(value){var thirded=Math.pow(value,3);if(thirded>0.008856){return thirded;}return(value-16/116)/7.787;}},{key:'_labToXyz',value:function _labToXyz(lab){if(!this._isLab(lab)){throw new Error('Not a valid LAB object');}var l=lab.l*100;var a=lab.a*255-128;var b=lab.b*255-128;var y=(l+16)/116;var x=a/500+y;var z=y-b/200;var xyzObj={x:this.__labBackward(x)*0.9504285,y:this.__labBackward(y),z:this.__labBackward(z)*1.0889};return xyzObj;}},{key:'_labToHsv',value:function _labToHsv(lab){return this._xyzToHsv(this._labToXyz(lab));}},{key:'_hsvToLab',value:function _hsvToLab(hsv){return this._xyzToLab(this._hsvToXyz(hsv));}},{key:'__rgbToCmy',value:function __rgbToCmy(rgb){var cmyObj={c:1-rgb.r,m:1-rgb.g,y:1-rgb.b};return cmyObj;}},{key:'__cmyToRgb',value:function __cmyToRgb(cmy){var rgbObj={r:1-cmy.c,g:1-cmy.m,b:1-cmy.y};return rgbObj;}},{key:'__cmyToCmyk',value:function __cmyToCmyk(cmy){if(!this._isCmy(cmy)){throw new Error('Not a valid cmy object.');}var K=1;if(cmy.x<K){K=cmy.c;}if(cmy.m<K){K=cmy.m;}if(cmy.y<K){K=cmy.y;}if(K===1){var cmykObj={c:0,m:0,y:0,k:1};return cmykObj;}var cmykObj={c:(cmy.c-K)/(1-K),m:(cmy.m-K)/(1-K),y:(cmy.y-K)/(1-K),k:K};return cmykObj;}},{key:'__cmykToCmy',value:function __cmykToCmy(cmyk){var K=cmyk.k;var cmyObj={c:cmyk.c*(1-K)+K,m:cmyk.m*(1-K)+K,y:cmyk.y*(1-K)+K};return cmyObj;}},{key:'_rgbToCmyk',value:function _rgbToCmyk(rgb){if(!this._isRgb(rgb)){throw new Error('Not a valid rgb object.');}return this.__cmyToCmyk(this.__rgbToCmy(rgb));}},{key:'_cmykToRgb',value:function _cmykToRgb(cmyk){if(!this._isCmyk(cmyk)){throw new Error('Not a valid cmyk object.');}return this.__cmyToRgb(this.__cmykToCmy(cmyk));}},{key:'_cmykToHsv',value:function _cmykToHsv(cmyk){return this._rgbToHsv(this._cmykToRgb(cmyk));}},{key:'_hsvToCmyk',value:function _hsvToCmyk(hsv){return this._rgbToCmyk(this._hsvToRgb(hsv));}}]);return Color;}();exports.default=Color;;

/***/ },
/* 7 */
/***/ function(module, exports) {

	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var htmlColors=exports.htmlColors={aliceblue:'F0F8FF',antiquewhite:'FAEBD7',aqua:'00FFFF',aquamarine:'7FFFD4',azure:'F0FFFF',beige:'F5F5DC',bisque:'FFE4C4',black:'000000',blanchedalmond:'FFEBCD',blue:'0000FF',blueviolet:'8A2BE2',brown:'A52A2A',burlywood:'DEB887',cadetblue:'5F9EA0',chartreuse:'7FFF00',chocolate:'D2691E',coral:'FF7F50',cornflowerblue:'6495ED',cornsilk:'FFF8DC',crimson:'DC143C',cyan:'00FFFF',darkblue:'00008B',darkcyan:'008B8B',darkgoldenrod:'B8860B',darkgray:'A9A9A9',darkgrey:'A9A9A9',darkgreen:'006400',darkkhaki:'BDB76B',darkmagenta:'8B008B',darkolivegreen:'556B2F',darkorange:'FF8C00',darkorchid:'9932CC',darkred:'8B0000',darksalmon:'E9967A',darkseagreen:'8FBC8F',darkslateblue:'483D8B',darkslategray:'2F4F4F',darkslategrey:'2F4F4F',darkturquoise:'00CED1',darkviolet:'9400D3',deeppink:'FF1493',deepskyblue:'00BFFF',dimgray:'696969',dimgrey:'696969',dodgerblue:'1E90FF',firebrick:'B22222',floralwhite:'FFFAF0',forestgreen:'228B22',fuchsia:'FF00FF',gainsboro:'DCDCDC',ghostwhite:'F8F8FF',gold:'FFD700',goldenrod:'DAA520',gray:'808080',grey:'808080',green:'008000',greenyellow:'ADFF2F',honeydew:'F0FFF0',hotpink:'FF69B4',indianred:'CD5C5C',indigo:'4B0082',ivory:'FFFFF0',khaki:'F0E68C',lavender:'E6E6FA',lavenderblush:'FFF0F5',lawngreen:'7CFC00',lemonchiffon:'FFFACD',lightblue:'ADD8E6',lightcoral:'F08080',lightcyan:'E0FFFF',lightgoldenrodyellow:'FAFAD2',lightgray:'D3D3D3',lightgrey:'D3D3D3',lightgreen:'90EE90',lightpink:'FFB6C1',lightsalmon:'FFA07A',lightseagreen:'20B2AA',lightskyblue:'87CEFA',lightslategray:'778899',lightslategrey:'778899',lightsteelblue:'B0C4DE',lightyellow:'FFFFE0',lime:'00FF00',limegreen:'32CD32',linen:'FAF0E6',magenta:'FF00FF',maroon:'800000',mediumaquamarine:'66CDAA',mediumblue:'0000CD',mediumorchid:'BA55D3',mediumpurple:'9370D8',mediumseagreen:'3CB371',mediumslateblue:'7B68EE',mediumspringgreen:'00FA9A',mediumturquoise:'48D1CC',mediumvioletred:'C71585',midnightblue:'191970',mintcream:'F5FFFA',mistyrose:'FFE4E1',moccasin:'FFE4B5',navajowhite:'FFDEAD',navy:'000080',oldlace:'FDF5E6',olive:'808000',olivedrab:'6B8E23',orange:'FFA500',orangered:'FF4500',orchid:'DA70D6',palegoldenrod:'EEE8AA',palegreen:'98FB98',paleturquoise:'AFEEEE',palevioletred:'D87093',papayawhip:'FFEFD5',peachpuff:'FFDAB9',peru:'CD853F',pink:'FFC0CB',plum:'DDA0DD',powderblue:'B0E0E6',purple:'800080',rebeccapurple:'663399',red:'FF0000',rosybrown:'BC8F8F',royalblue:'4169E1',saddlebrown:'8B4513',salmon:'FA8072',sandybrown:'F4A460',seagreen:'2E8B57',seashell:'FFF5EE',sienna:'A0522D',silver:'C0C0C0',skyblue:'87CEEB',slateblue:'6A5ACD',slategray:'708090',slategrey:'708090',snow:'FFFAFA',springgreen:'00FF7F',steelblue:'4682B4',tan:'D2B48C',teal:'008080',thistle:'D8BFD8',tomato:'FF6347',turquoise:'40E0D0',violet:'EE82EE',wheat:'F5DEB3',white:'FFFFFF',whitesmoke:'F5F5F5',yellow:'FFFF00',yellowgreen:'9ACD32'};
