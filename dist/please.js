...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _lodash=__webpack_require__(3);var _util=__webpack_require__(7);var _util2=_interopRequireDefault(_util);var _hsv=__webpack_require__(8);var _hsv2=_interopRequireDefault(_hsv);var _rgb=__webpack_require__(9);var _rgb2=_interopRequireDefault(_rgb);var _hex=__webpack_require__(10);var _hex2=_interopRequireDefault(_hex);var _html=__webpack_require__(11);var _html2=_interopRequireDefault(_html);var _cmyk=__webpack_require__(12);var _cmyk2=_interopRequireDefault(_cmyk);var _hsl=__webpack_require__(13);var _hsl2=_interopRequireDefault(_hsl);var _xyz=__webpack_require__(14);var _xyz2=_interopRequireDefault(_xyz);var _lab=__webpack_require__(15);var _lab2=_interopRequireDefault(_lab);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var Color=function(){function Color(color){_classCallCheck(this,Color);_util2.default.call(this);_hsv2.default.call(this);_rgb2.default.call(this);_hex2.default.call(this);_html2.default.call(this);_cmyk2.default.call(this);_hsl2.default.call(this);_xyz2.default.call(this);_lab2.default.call(this);if(color!=null){switch(this._detectType(color)){case'HSV':this.hsv(color);break;case'HSL':this.__model=this._hslToHsv(color);break;case'RGB':this.__model=this._rgbToHsv(color);break;case'HEX':this.__model=this._hexToHsv(color);break;case'XYZ':this.__model=this._xyzToHsv(color);break;case'LAB':this.__model=this._labToHsv(color);break;case'CMYK':this.__model=this._cmykToHsv(color);break;case'HTML':this.__model=this._htmlToHsv(color);break;}}else{this.hsv({h:0,s:0,v:0});}}/**
		 * Getter/Setter for alpha property.
		 * @param  {Number} value
		 * @return {Object}
		 */_createClass(Color,[{key:'alpha',value:function alpha(value){if(value!=null&&(0,_lodash.isNumber)(value)){this.__model.a=(0,_lodash.clamp)(value,0,1);return this;}return this.__model.a;}/**
		 * Alias for alpha.
		 * @param  {Number} value
		 * @return {Function}
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(3);var Util=function Util(){/**
		 ...
		 * @param  {Any} color
		 * @return {Boolean}
		 */this._isHtml=function(color){var normalizedColor=color.toLowerCase();if((0,_lodash.isString)(normalizedColor)&&normalizedColor in this._htmlColors){return true;}return false;};/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(3);var Hsv=function Hsv(){this._hsvToRgb=function(hsv){if(!this._isHsv(hsv)){throw new Error('Not a valid HSV object.');}var h=hsv.h%360;var s=hsv.s;var v=hsv.v;//no saturation case
	if(s===0){var computedV=v*255;var rgbObj={r:computedV,g:computedV,b:computedV};return rgbObj;}h/=60;var i=Math.floor(h);var f=h-i;var p=v*(1-s);var q=v*(1-s*f);var t=v*(1-s*(1-f));var r=void 0,g=void 0,b=void 0;switch(i){case 0:r=v;g=t;b=p;break;case 1:r=q;g=v;b=p;break;case 2:r=p;g=v;b=t;break;case 3:r=p;g=q;b=v;break;case 4:r=t;g=p;b=v;break;case 5:r=v;g=p;b=q;break;}var rgbObj={r:Math.floor(r*255),g:Math.floor(g*255),b:Math.floor(b*255)};return rgbObj;};this._hsvToHex=function(hsv){return this._rgbToHex(this._hsvToRgb(hsv));};this._hsvToHsl=function(hsv){if(!this._isHsv(hsv)){throw new Error('Not a valid HSV object.');}var computedL=(2-hsv.s)*hsv.v;var computedS=hsv.s*hsv.v;if(computedL<=1){computedS=computedS/computedL;}else{computedS=computedS/(2-computedL);}computedL=computedL/2;var hslObj={h:hsv.h,s:computedS,l:computedL};return hslObj;};this._hsvToXyz=function(hsv){return this._rgbToXyz(this._hsvToRgb(hsv));};this._hsvToCmyk=function(hsv){return this._rgbToCmyk(this._hsvToRgb(hsv));};this._hsvToLab=function(hsv){return this._xyzToLab(this._hsvToXyz(hsv));};/**
		 ...
		 * @param  {Number} value
		 * @return {Object}
		 */this.hue=function(value){if(value!=null&&(0,_lodash.isNumber)(value)){this.__model.h=Math.abs(value%360);return this;}return this.__model.h;};/**
		 * Getter/Setter for saturation property.
		 * @param  {Number} value
		 * @return {Object}
		 */this.saturation=function(value){if(value!=null&&(0,_lodash.isNumber)(value)){this.__model.s=(0,_lodash.clamp)(value,0,1);return this;}return this.__model.s;};/**
		 ...
		 * @param  {Number} value
		 * @return {Object}
		 */this.value=function(value){if(value!=null&&(0,_lodash.isNumber)(value)){this.__model.v=(0,_lodash.clamp)(value,0,1);return this;}return this.__model.v;};/**
		 * Alias for value.
		 * @param  {Number} value
		 * @return {Function}
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(3);var Rgb=function Rgb(){this.red=function(value){if(value!=null&&(0,_lodash.isNumber)(value)){var rgb=this._hsvToRgb(this.__model);rgb.r=(0,_lodash.clamp)(value,0,255);this.__model=this._rgbToHsv(rgb);return this;}return this._hsvToRgb(this.__model).r;};this.green=function(value){if(value!=null&&(0,_lodash.isNumber)(value)){var rgb=this._hsvToRgb(this.__model);rgb.g=(0,_lodash.clamp)(value,0,255);this.__model=this._rgbToHsv(rgb);return this;}return this._hsvToRgb(this.__model).g;};this.blue=function(value){if(value!=null&&(0,_lodash.isNumber)(value)){var rgb=this._hsvToRgb(this.__model);rgb.b=(0,_lodash.clamp)(value,0,255);this.__model=this._rgbToHsv(rgb);return this;}return this._hsvToRgb(this.__model).b;};this.rgb=function(value){if(value!=null){this.__model=this._rgbToHsv(value);return this;}return this._hsvToRgb(this.__model);};this.rgbString=function(){var rgb=this.rgb();var r=Math.round(rgb.r);var g=Math.round(rgb.g);var b=Math.round(rgb.b);if(this.__model.a==null){return'rgb('+r+','+g+','+b+')';}return'rgba('+r+','+g+','+b+','+this.__model.a+')';};this._rgbToHsv=function(rgb){if(!this._isRgb(rgb)){throw new Error('Not a valid RGB object.');}var r=rgb.r/255;var g=rgb.g/255;var b=rgb.b/255;var minRgb=Math.min(r,Math.min(g,b));var maxRgb=Math.max(r,Math.max(g,b));//Black-gray-white
