...
# private testing
# ###
# please.isObject = isObject
# please.isArray = isArray
# please.isObjectLike = isObjectLike
# please.isString = isString
# please.objToString = objToString
# please.isNumber = isNumber
# please.isNaN = isNaN
# please.clamp = clamp
# please.randomInt = randomInt
# please.randomFloat = randomFloat
# please.defaults = defaults
# ###
# end private testing
# ###